...
class TestInternal(unittest.TestCase):
    ...
    def test_wait_until_page_contains_private(self):
        mock_desk = MagicMock()
        DesktopLibrary._wait_until_page_contains(mock_desk, 'some_text', 5, 'custom_error_message')
    ...
    def test_wait_until_page_contains_element_private(self):
        mock_desk = MagicMock()
        DesktopLibrary._wait_until_page_contains_element(mock_desk, 'some_element', 5, 'custom_error_message')
